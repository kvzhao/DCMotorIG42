#ifndef DualVNH2SH30MotorShield_h
#define DualVNH2SH30MotorShield_h

#include <Arduino.h>

class DualVNH2SH30MotorShield
{
  public:  
    // CONSTRUCTORS
    DualVNH2SH30MotorShield(); // Default pin selection.
    DualVNH2SH30MotorShield(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
